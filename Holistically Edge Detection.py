...
protoPath = 'C:/Users/ramos/Documents/Data_Science/coco/modelos/deploy.prototxt'
modelPath = 'C:/Users/ramos/Documents/Data_Science/coco/modelos/hed_pretrained_bsds.caffemodel'
...
image_path = 'C:/Users/ramos/Documents/Data_Science/coco/train/i_crop/conta01.tif'
...
# 'major_axis_length': The length of the major axis of each region.
# 'minor_axis_length': The length of the minor axis of each region.

# import pandas as pd
# df = pd.DataFrame(props)

# # # Pixel to mm ratio
# # moeda_path = 'C:/Users/ramos/Downloads/escala moeda 02.jpeg'
# # moeda = cv2.imread(moeda_path)

# # # Convert BGR to RGB
# # moeda_rgb = cv2.cvtColor(moeda, cv2.COLOR_BGR2RGB)

# # plt.imshow(moeda_rgb)
# # plt.title('Escala das Imagens do Dataset')
...
# csv_path = 'C:/Users/ramos/Desktop/coco/output.csv'
